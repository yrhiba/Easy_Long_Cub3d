...
/*   Updated: 2024/01/14 01:59:06 by yrhiba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void render_minmap_player(t_data *data)
{
	...
	vel.x = data->player->minmap_pos.x + round(cos(data->player->rotation_angle) * (30 * MINMAP_FACTOR));
	vel.y = data->player->minmap_pos.y + round(sin(data->player->rotation_angle) * (30 * MINMAP_FACTOR));
